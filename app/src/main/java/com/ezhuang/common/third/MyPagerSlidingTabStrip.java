...
//
//		addTab(position, tab);
        View v = mInflater.inflate(com.ezhuang.R.layout.imageview_head, null, false);
        ImageView head = (ImageView) v.findViewById(com.ezhuang.R.id.head);
        if (url.isEmpty()) {
            head.setImageResource(com.ezhuang.R.mipmap.icon_all_task);
        } else {
