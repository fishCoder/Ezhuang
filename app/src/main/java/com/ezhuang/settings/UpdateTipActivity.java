...
import com.ezhuang.UpdateService;
...
public class UpdateTipActivity extends Activity {
    ...
    private void showNoticeDialog() {
        ...
        message.setText(mUpdateInfo.displayMessage);
...
//        if (mUpdateInfo. == 1 || mUpdateInfo.required == 0) {
            ...
            buttonJump.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    editor.putInt("jump", mUpdateInfo.versionCode);
                    editor.commit();
                    startUpdateService(UpdateService.PARAM_STOP_SELF);
                    finish();
                }
