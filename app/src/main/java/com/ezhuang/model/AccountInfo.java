...
public class AccountInfo {
    ...
    public static void saveAccount(Context ctx, StaffUser data) {
    ...
    public static StaffUser loadAccount(Context ctx) {
        StaffUser data = null;
        File file = new File(ctx.getFilesDir(), ACCOUNT);
        if (file.exists()) {
            try {
                ObjectInputStream ois = new ObjectInputStream(ctx.openFileInput(ACCOUNT));
                data = (StaffUser) ois.readObject();
                ois.close();
            } catch (Exception e) {
                e.printStackTrace();
            }
    ...
    public static void saveProjects(Context ctx, ArrayList<Project> data) {
        if (ctx == null) {
            return;
        }
    ...
    public static ArrayList<Project> loadProjects(Context ctx) {
