...
public class AttachmentFileObject implements Serializable {
    ...
    public String name = "";
    public StaffUser owner = new StaffUser();
    ...
    public AttachmentFileObject(JSONObject json) throws JSONException {
        ...
        if (json.has("owner")) {
            owner = JsonUtil.Json2Object(json.getJSONObject("owner").toString(),StaffUser.class);
        }
